...
//Add by Hongzhi Chen
ibinstream& operator<<(ibinstream& m, unsigned long long int i)
{
	m.raw_bytes(&i, sizeof(unsigned long long int));
	return m;
}

//Add by Da Yan
ibinstream& operator<<(ibinstream& m, long long int i)
{
	m.raw_bytes(&i, sizeof(long long int));
	return m;
}
...
ibinstream& operator<<(ibinstream& m, unsigned char c)
{
	m.raw_byte(c);
	return m;
}
...
//Add by Hongzhi Chen
obinstream& operator>>(obinstream& m, unsigned long long int & i)
{
	i = *(unsigned long long int*)m.raw_bytes(sizeof(unsigned long long int));
	return m;
}

//Add by Da Yan
obinstream& operator>>(obinstream& m, long long int & i)
{
	i = *(long long int*)m.raw_bytes(sizeof(long long int));
	return m;
}
...
obinstream& operator>>(obinstream& m, unsigned char& c)
{
	c = m.raw_byte();
	return m;
}
